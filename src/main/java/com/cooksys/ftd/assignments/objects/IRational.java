...
interface IRational {
	...
	default IRational add(IRational that) throws IllegalArgumentException {
		...
		int newNum;
		int newDen;
		newNum = getNumerator()*that.getDenominator()+that.getNumerator()*getDenominator();
		newDen = getDenominator()*that.getDenominator();
	...
	default IRational sub(IRational that) throws IllegalArgumentException {
		...
		int newNum = getNumerator() * that.getDenominator() - that.getNumerator()*getDenominator();
		int newDen = getDenominator() * that.getDenominator();
		return construct(newNum, newDen);
	}
	...
	default IRational mul(IRational that) throws IllegalArgumentException {
		...
		int newNum = getNumerator()*that.getNumerator();
		int newDen = getDenominator()*that.getDenominator();
		return construct(newNum, newDen);
	}
	...
	default IRational div(IRational that) throws IllegalArgumentException {
		...
		int newNum = getNumerator() * that.getDenominator();
		int newDen = getDenominator() * that.getNumerator();
		return construct(newNum, newDen);
	}
}
